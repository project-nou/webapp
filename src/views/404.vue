<template>
  <div class="error_page">
    ...
    <a href="https://codepen.io/SofiaSergio/" target="_blank">
      <div id="link">
        <!-- To register -->
        <router-link to="/my_groups" class="to_register_text font-weight-thin">
          <a class="white--text">
            <v-btn small>Retourner sur l'application</v-btn>
          </a>
        </router-link>
      </div>
    </a>
...
body {font-family: 'Concert One', cursive; margin: 0; overflow: hidden; padding: 0; }
